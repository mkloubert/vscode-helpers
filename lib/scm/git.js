...
class GitClient {
    ...
    execSync(args, opts) {
        ...
        return ChildProcess.execFileSync(this.executable.path, vscode_helpers.asArray(args, false)
...
function runCommandSync(command, args) {
    return ChildProcess.execFileSync(vscode_helpers.toStringSafe(command), vscode_helpers.asArray(args, false)
